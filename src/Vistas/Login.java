...
public class Login extends javax.swing.JFrame {
    ...
    private UsuarioJpaController userCo;
    ...
    public Login() {
        ...
        userCo = new UsuarioJpaController(persis.getEmf());
    }
    ...
    private void loginBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseClicked
        ...
        try {
            ...
            Usuario user = userCo.validarCredenciales(usuario, pass);
    ...
    public void ventanaAdministrador() {
        Administrador pri = new Administrador();
        pri.setVisible(true);
        this.dispose();
    }

    public void ventanaOrganizador() {
        Organizador pri = new Organizador();
        pri.setVisible(true);
        this.dispose();
    }

    public void ventanaPublico() {
        Publico pri = new Publico();
        pri.setVisible(true);
        this.dispose();
    }

    public void ventanaArtista() {
        Artista pri = new Artista();
        pri.setVisible(true);
        this.dispose();
    }
